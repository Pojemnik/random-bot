...
module.exports = {
    name: 'getmapdocs',
    description: `Displays documentation of Storkman's world map`,
    ...
    init() {
        ...
        let data = '';
        let url = 'https://raw.githubusercontent.com/Pojemnik/StorkMan/master/docs/xml%20opisu%20mapy.txt';
